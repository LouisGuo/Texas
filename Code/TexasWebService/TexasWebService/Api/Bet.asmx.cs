...
namespace TexasWebService.Api
{
    ...
    public class Bet : System.Web.Services.WebService
    {
        ...
        public DataSet GetBetForLive()
        {
            ...
            var table = db.GetDataSet("select * from Operations where GameID=" + gameID);
        ...
        public DataSet GetBetForLive1()
        {
            ...
            if (table.Tables[0].Rows.Count == 0)
            {
                ...
                {
                    int recordID = int.Parse(ds.Tables[0].Rows[0]["ID"].ToString());
        ...
        {
            var set = db.GetDataSet("select * from Operations where GameID in (select ID from Games where RecordID=" + recordID + ")");
            return set;
        }
